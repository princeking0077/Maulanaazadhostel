// Local Storage Service - Direct IndexedDB Interaction
import { db, Student, Payment, Room, FacilityTransaction } from '../database/db';

console.log('Storage Service Initialized - Offline Only Mode');

// ==================== STUDENTS ====================

// Helper to sanitize student data (ensure compatibility with UI)
function sanitizeStudent(student: Student): Student {
  return {
    ...student,
    name: student.name || '',
...
export const authStorage = {
  async login(username: string, password: string): Promise<boolean> {
    // Offline mode - simple check against db users
