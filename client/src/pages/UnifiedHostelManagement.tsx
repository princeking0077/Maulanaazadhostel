...
export default function Admission() {
    ...
    const [studentForm, setStudentForm] = useState({
        ...
        wing: '' as 'A' | 'B' | 'C' | 'D' | '',
        roomNo: '',
        residency: 'Permanent' as 'Permanent' | 'Temporary',
        studentType: 'Hosteller' as Student['studentType'], // Default to Hosteller
    ...
    const [paymentForm, setPaymentForm] = useState({
        studentId: '',
        paymentType: 'Full Payment' as 'Full Payment' | 'Installment',
        securityDeposit: 0 as number | string,
        registrationFees: 0 as number | string,
        roomRent: 0 as number | string,
        waterElectricity: 0 as number | string,
        gym: 0 as number | string,
        others: 0 as number | string,
        paymentMode: 'Cash',
        utr: '',
